        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    ...
                    <spring:message code="menu.student"/>
                    </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled" style="display: none;">
                        <li><a href="/studentList"><spring:message code="menu.submenu.all.student"/></a></li>
                        <li><a href="/addStudent"><spring:message code="menu.submenu.add.student"/></a></li>
                        <li><a href="edit-student.html"><spring:message code="menu.submenu.edit.student"/></a></li>
                        <li><a href="about-student.html"><spring:message code="menu.submenu.about.student"/></a></li>
                    </ul>
                </li>
                <li class="submenu">
